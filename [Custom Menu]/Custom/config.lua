...
Config.shopProfit = { ['mechanic'] = 85,  ['mechanic'] = 50 }

-- Role
Config.RequiredRole = {'mechanic'}
Config.Hint  = _U('press_custom')
Config.Zones = {
	--BENNYS
	{
		Pos   = {x = -234.14131164551, y = -1337.7728271484, z = 30.902793884277},
	...
	{
		Pos   = {x = -239.78788757324, y = -1337.8768310547, z = 30.902809143066},
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 27,
		Name  = _U('blip_name'),
	...
	{
		Pos   = {x = -233.70597839355, y = -1316.4332275391, z = 30.902801513672},
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 27,
		Name  = _U('blip_name'),
	...
	{
		Pos   = {x = -199.44032287598, y = -1324.3410644531, z = 31.126907348633},
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 27,
		Name  = _U('blip_name'),
